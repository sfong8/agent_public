...
sec1_headers = ["Field", "Value", "Source"]
...
sec2_headers = ["Field", "Value", "Source"]
sec2_col_widths = [50, 90, 40]
add_table_header(pdf, sec2_headers, sec2_col_widths)
sec2_data = [
    ["Loan Amount Requested:", "£10m", " "],
    ["Purpose of Loan:", "Investment in a new bottling and packaging line to meet escalating demand", "External (Annual Report Analysis) / CRM"],
...
sec3_headers = ["Field", "Value", "Source"]
...
sec4_headers = ["Field", "Value", "Source"]
